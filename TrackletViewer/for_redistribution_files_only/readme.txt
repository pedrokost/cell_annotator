...
================================
-TrackletViewer 
-run_TrackletViewer.sh (shell script for temporarily setting environment variables and 
                        executing the application)
   -to run the shell script, type
   
       ./run_TrackletViewer.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v83, run the shell script as:
       ...
       ./run_TrackletViewer.sh /mathworks/home/application/v83
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_TrackletViewer.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
A. Linux x86-64 systems:
   ...
   the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_TrackletViewer.sh 
